...
目前官网文档中的demo都是基于SDK 6.X，版本低于6.X的可参考 [5.X开发文档](https://github.com/ali-sdk/ali-oss/blob/5.x/README.md)，如要升级至6.X请参考[升级文档](/intl.zh-CN/产品简介/什么是对象存储OSS.md)。
...
-   使用RAM用户或STS方式访问
    ...
    由于阿里云账号AccessKey拥有所有API访问权限，建议遵循阿里云安全最佳实践。如果部署在服务端可以使用RAM用户或STS来进行API访问或日常运维管控操作，如果部署在客户端请使用STS方式来进行API访问。详情请参见[访问控制](/intl.zh-CN/开发指南/数据安全/访问控制/访问控制概述.md)。
