...
-   您可以在上传Object时设置对象标签，也可以对已上传Object设置对象标签。设置对象标签时，若对象已有标签，则覆盖原标签。关于设置对象标签的更多信息，请参见[t159899.md\#](/intl.zh-CN/API 参考/关于Object操作/标签（Tagging）/PutObjectTagging.md)。
...
对象标签使用一组键值对（Key-Value）来标记对象。关于对象标签的更多信息，请参见[对象标签](/intl.zh-CN/开发指南/对象/文件（Object）/管理文件/对象标签.md)。
