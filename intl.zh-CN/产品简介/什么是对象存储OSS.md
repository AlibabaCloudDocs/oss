...
您可以使用在线迁移服务将第三方数据源，如亚马逊AWS、谷歌云等数据轻松迁移至OSS。详细信息，请参见[在线迁移服务使用教程](https://www.alibabacloud.com/help/product/94157.htm)。
...
除了对象存储以外，阿里云还提供文件存储、块存储等类型的存储服务，满足您不同场景下的业务需求。详细信息，请参见[阿里云存储服务介绍]()。
