...
4.  On the Syntax tab, click **Edit**.
    ...
    -   Example 3: Allow a RAM user whose UID is `20214760404935xxxx` only to read the `hangzhou/2020` and `hangzhou/2015` folders in a public-read bucket named examplebucket.
