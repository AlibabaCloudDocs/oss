...
3.  添加CNAME记录。
    ...
    若您的域名为非阿里云托管的域名，需在对应的域名解析商处配置云解析。如腾讯云解析（原DNSPod）或新网添加CANME的步骤，请参见 [DNSPod配置CNAME流程](https://help.aliyun.com/document_detail/27145.html)或[新网配置CNAME流程](https://help.aliyun.com/document_detail/27146.html)。此处以阿里云托管的域名为例，添加CNAME记录步骤如下：
